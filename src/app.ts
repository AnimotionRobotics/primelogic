 ...
 */
import { SIGINT_HANDLER, SIGTERM_HANDLER, UNCAUGHT_EXCEPTION_HANDLER, APP_START_HANDER, APP_ERROR_HANDLER } from "./apphandlers/index"
...
process.once('APPSTART', APP_START_HANDER)
